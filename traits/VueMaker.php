...
use Backend;
use SystemException;
use Initbiz\PowerComponents\Classes\VueComponentBase;
    ...
    protected function makeVueComponent($className)
    {
        ...
        if (!$component instanceof VueComponentBase) {
            throw new SystemException(
                sprintf('Vue component class must be a descendant of Initbiz\PowerComponents\Classes\VueComponentBase: %s', $className)
            );
        }
